...
public class FitnessFrageViewAdapter extends RecyclerView.Adapter<FitnessFrageViewAdapter.FitnessFrageHolder>{
    ...
    public  class FitnessFrageHolder extends RecyclerView.ViewHolder  {
        ...
        FitnessFrageHolder(View itemView) {
            super(itemView);
            txtTitle = (TextView) itemView.findViewById(org.tud.bp.fitup.R.id.txtDateFitnessfragebogen);
            //txtSubText = (TextView) itemView.findViewById(R.id.txtTimeFitnessfragebogen);
            cv = (CardView) itemView.findViewById(org.tud.bp.fitup.R.id.card_view_fitnessfragebogen);
            imageView = (ImageView) itemView.findViewById(org.tud.bp.fitup.R.id.imgViewFitnessfragebogen);
            view = itemView;
        }
    ...
    public FitnessFrageViewAdapter.FitnessFrageHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(org.tud.bp.fitup.R.layout.cardview_fitnessfragebogen,
                viewGroup, false);
    ...
    public void onBindViewHolder(final FitnessFrageViewAdapter.FitnessFrageHolder holder, final int position) {
        ...
        fitnessFrageHolder.imageView.setImageResource(org.tud.bp.fitup.R.mipmap.ic_fittnessfragebogen);
        ...
        holder.view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (selectedPosition != -1) {
                    ...
                    open.putExtra(context.getString(org.tud.bp.fitup.R.string.fitnessfragebogen), fitnessFragebogen);
