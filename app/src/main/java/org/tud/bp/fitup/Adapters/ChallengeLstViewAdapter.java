...
public class ChallengeLstViewAdapter extends RecyclerView.Adapter<ChallengeLstViewAdapter.ChallengeHolder> {
    ...
    public class ChallengeHolder extends RecyclerView.ViewHolder {
        ...
        ChallengeHolder(View itemView) {
            super(itemView);
            txtTitle = (TextView) itemView.findViewById(org.tud.bp.fitup.R.id.txtDateLstChallenge);
            txtSubText = (TextView) itemView.findViewById(org.tud.bp.fitup.R.id.txtTimeLstChallenge);
            cv = (CardView) itemView.findViewById(org.tud.bp.fitup.R.id.card_view_lstchallenge);
            imageView = (ImageView) itemView.findViewById(org.tud.bp.fitup.R.id.imgViewLstChallenge);
            view = itemView;
        }
    ...
    public ChallengeHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(org.tud.bp.fitup.R.layout.cardview_lstchallenge, viewGroup, false);
    ...
    public void onBindViewHolder(final ChallengeHolder holder, final int position) {
        ...
        challengeHolder.imageView.setImageResource(org.tud.bp.fitup.R.mipmap.ic_challenge);
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedPosition != -1) {
                    ...
                    open.putExtra(context.getString(org.tud.bp.fitup.R.string.Challenges), challenge);
    ...
    private String getDateOrFinished(Challenge challenge) {
        ...
        if (challenge.finished())
            return context.getString(org.tud.bp.fitup.R.string.ChallengeBeendet);
        else
            return context.getString(org.tud.bp.fitup.R.string.EndetAm) + " " + sdf.format(challenge.getEndDate()).toString();
    }
