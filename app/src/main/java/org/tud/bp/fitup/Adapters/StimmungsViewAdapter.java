...
public class StimmungsViewAdapter extends BaseAdapter {
    ...
    public StimmungsViewAdapter(Activity context) {
        ...
        stimmungen.add(context.getString(org.tud.bp.fitup.R.string.ueberhaupt_nicht));
        stimmungen.add(context.getString(org.tud.bp.fitup.R.string.wenig));
        stimmungen.add(context.getString(org.tud.bp.fitup.R.string.mittelmaessig));
        stimmungen.add(context.getString(org.tud.bp.fitup.R.string.ziemlich));
        stimmungen.add(context.getString(org.tud.bp.fitup.R.string.extrem));
