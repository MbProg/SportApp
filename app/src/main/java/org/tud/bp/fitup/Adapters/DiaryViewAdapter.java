...
public class DiaryViewAdapter extends RecyclerView.Adapter<DiaryViewAdapter.DiaryEntryHolder> {
    ...
    public class DiaryEntryHolder extends RecyclerView.ViewHolder {
        ...
        DiaryEntryHolder(View itemView) {
            super(itemView);
            txtTitle = (TextView) itemView.findViewById(org.tud.bp.fitup.R.id.txtDateDiary);
            txtSubText = (TextView) itemView.findViewById(org.tud.bp.fitup.R.id.txtTimeDiary);
            cv = (CardView) itemView.findViewById(org.tud.bp.fitup.R.id.card_view_diary);
            imageView = (ImageView) itemView.findViewById(org.tud.bp.fitup.R.id.imgViewDiary);
            view = itemView;
        }
    ...
    public DiaryEntryHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        //// TODO: 26.03.2017  
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(org.tud.bp.fitup.R.layout.cardview_diary, viewGroup, false);
    ...
    public void onBindViewHolder(final DiaryEntryHolder holder, final int position) {
        ...
        diaryEntryHolder.imageView.setImageResource(org.tud.bp.fitup.R.mipmap.ic_tagebuch_eintrag);
