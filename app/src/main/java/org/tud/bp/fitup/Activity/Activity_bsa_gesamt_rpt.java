...
public class Activity_bsa_gesamt_rpt extends Activity_LineChartReports {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tud.bp.fitup.R.layout.activity_bsa_gesamt_rpt);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case org.tud.bp.fitup.R.id.alldays:
                computeDrawThree(null, new Date(), lineChart, Activity_bsa_gesamt_rpt.this.getString(org.tud.bp.fitup.R.string
                        .erzielte_punkte));
                return true;
            default:
    ...
    protected void onStart() {
        super.onStart();
        computeDrawThree(addDays(new Date(), -7), new Date(), lineChart, Activity_bsa_gesamt_rpt.this.getString(org
                                                    ...
                                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                                        ...
                                                        if (xAXES.size() != 0) {
                                                            ...
                                                            LineDataSet lineDataSet1 = new LineDataSet(yAXES_Gesamt,
                                                                    Activity_bsa_gesamt_rpt.this.getString(org.tud.bp.fitup.R.string
                                                                            .gesagmtewerte));
