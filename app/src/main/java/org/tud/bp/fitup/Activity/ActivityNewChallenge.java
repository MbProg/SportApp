...
public class ActivityNewChallenge extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.icon_save:
                ...
                if(startDate.before(standardCalendar.getTime()))
                    ...
                    inviteUsers(challenge, this);
                    //Save challenge to firebase
                    challenge.SaveNewChallenge(this);
                    //Add user too challenge
                    challenge.AddUser(ActivityMain.getMainUser(this), this);
                    //The creator is automatically the admin
                    challenge.AddAdmin(ActivityMain.getMainUser(this), this);
     ...
     * @param challenge
     */
    public void inviteUsers(Challenge challenge, Context context){
        for(User user : userList){
            challenge.InviteUser(user, context);
        }
    }
