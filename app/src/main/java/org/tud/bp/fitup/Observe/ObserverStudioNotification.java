...
public class ObserverStudioNotification extends Observer {
    ...
    private void searchChallengesToNotify() {
        ...
        //URL url = null;
        try {
            URL url = new URL(DAL_Utilities.getDatabaseURL(context) + "/users/" + ActivityMain.getMainUser(context).getName() +
                    "/Challenges/");
    ...
    private void doNotify(final String challengeName) {
        ...
        try {
            URL url = new URL(DAL_Utilities.getDatabaseURL(context) + "Challenges/" + challengeName + "/AtStudio");
            final Firebase root = new Firebase(url.toString());
                        ...
                        if (!usrName.equals(ActivityMain.getMainUser(context).getName())) {
                            if (usrName != "") {
                                ...
                                if (!sendNotif) {
                                    ...
                                    sendNotification(
                                            context,
                                            context.getString(org.tud.bp.fitup.R.string.Challenge),
                                            ActivityMain.class, context.getString(org.tud.bp.fitup.R.string.stimmungsabgabe),
                                            (usrName + " " + context.getString(org.tud.bp.fitup.R.string.IstGeradeImFitnessStudio)),
                                            org.tud.bp.fitup.R.mipmap.ic_challenge);
                                }
                            }
