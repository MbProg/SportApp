...
public class ActivityDiaryEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tud.bp.fitup.R.layout.activity_diaryentry);
        ...
        listCategories.add(org.tud.bp.fitup.R.string.Leistungstests);
        listCategories.add(org.tud.bp.fitup.R.string.Training);
        listCategories.add(org.tud.bp.fitup.R.string.Wellness);
        listCategories.add(org.tud.bp.fitup.R.string.ReinerAufenthalt);

        //set all icons for the viewadapter
        listIcons.add(org.tud.bp.fitup.R.drawable.ic_fitnesscheck);
        listIcons.add(org.tud.bp.fitup.R.drawable.ic_sport);
        listIcons.add(org.tud.bp.fitup.R.drawable.ic_wellness);
        listIcons.add(org.tud.bp.fitup.R.drawable.ic_aufenthalt);
        ...
        gridView = (GridView) findViewById(org.tud.bp.fitup.R.id.gridViewExercise);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(org.tud.bp.fitup.R.menu.menu_add_and_save , menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (item.getItemId()){
            case org.tud.bp.fitup.R.id.icon_add:
            ...
            case org.tud.bp.fitup.R.id.icon_save:
                ...
                if(diaryEntry.getExerciseList().size() > 0) {
                    ...
                    Toast.makeText(ActivityDiaryEntry.this, org.tud.bp.fitup.R.string.keintagebucheintragerstellt ,
    ...
    private boolean SaveData() {
        ...
        ActivityMain.getMainUser(this).SaveDiaryEntry(diaryEntry, this);
        Toast.makeText(ActivityDiaryEntry.this, org.tud.bp.fitup.R.string.Tagebucheintraggespeichert, Toast.LENGTH_SHORT).show();
