...
public class ActivityFitnessFragebogen extends AppCompatActivity {
    ...
    private boolean SaveData() {
        ...
        if (INSERT)
            ActivityMain.getMainUser(this).InsertFitnessFragebogen(fitnessfragebogen, this  );
        else
            ActivityMain.getMainUser(this).UpdateFitnessFragebogen(fitnessfragebogen, this);
