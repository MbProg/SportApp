...
public class ActivityLogin extends AppCompatActivity {
    ...
    public void finishLogin(String mUsername, boolean mLogin) {
        ...
        if (!mLogin) {
            ...
            registerCatcher.catchRegistration(user, this);
        }
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (mLogin) {
                try {
                    URL url = new URL(DAL_Utilities.getDatabaseURL(ActivityLogin.this) + "users/" + mUsername);
                    ...
                    root.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(dataSnapshot.getChildrenCount() > 0 ) {
                                ...
                                User.createUser(mUsername, getApplicationContext())
                                        .saveRegistration(mUsername, mPassword, ActivityLogin.this  );
                                finishLogin(mUsername,mLogin);
                            }
                        }
