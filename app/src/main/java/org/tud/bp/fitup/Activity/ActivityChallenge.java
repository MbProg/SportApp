...
public class ActivityChallenge extends AppCompatActivity {
        ...
        builder.setMessage(getString(R.string.MöchtenSieAnDerChallenge) + " " + challenge.getName() + "\n" +
                ...
                .setPositiveButton(R.string.Ja, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        challenge.AddUser(ActivityMain.getMainUser(ActivityChallenge.this), ActivityChallenge.this);
                        challenge.RemoveInvitation(ActivityMain.getMainUser(ActivityChallenge.this), ActivityChallenge.this);
    ...
    private void getChallengeUsers() {
        ...
        for (final String u : strUSer) {
            ...
            URL url = null;
            try {
                url = new URL(DAL_Utilities.getDatabaseURL(this) + "users/" + u + "/Diary/");
