...
public class DAL_Challenges {
    ...
    public static void getRegisteredChallengesToNewChallenge(
        ...
        try {
            URL url = new URL(DAL_Utilities.getDatabaseURL(activity) + "Challenges/");
    ...
    public static void getRegisteredUsersToChallenge(
        ...
        // access data in database and hand it to activity
        try {
            URL url = new URL(DAL_Utilities.getDatabaseURL(activity)+ "Challenges/" + challengeName + "/Users/");
            Firebase root = new Firebase(url.toString());
     ...
     */
    public static void InsertChallenge(Challenge challenge, Context context) {

        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");

        Firebase ref = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "Challenges/" + challenge.getName());
     ...
     * @param challenge current challenge
     */
    public static void InsertUser(User user, Challenge challenge, Context context) {
     ...
     * @param challenge current challenge
     */
    public static void InsertAdmin(User user, Challenge challenge, Context context) {
     ...
     * @param challenge current challenge
     */
    public static void InsertInvitation(User user, Challenge challenge, Context context) {

        Firebase ref = new Firebase(DAL_Utilities.getDatabaseURL(context) + "users/" + user.getName() + "/Invitations/Challenges");
     ...
     * @param challenge current challenge
     */
    public static void RemoveInvitation(User user, Challenge challenge, Context context) {
     ...
     * @param challenge current challenge
     */
    public static void RemoveUser(User user, Challenge challenge, Context context) {

        Firebase ref = new Firebase(DAL_Utilities.getDatabaseURL(context) + "Challenges/" + challenge.getName() + "/Users/");
