...
public class ActivityStimmungsAbgabe extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(org.tud.bp.fitup.R.layout.activity_stimmung);
        ...
        if (extras != null) {
            ...
            stimmungsAngabe = (StimmungsAngabe) iin.getSerializableExtra(getString(org.tud.bp.fitup.R.string.stimmungsabgabe));
        ...
        mRootRef = new Firebase(DAL_Utilities.getDatabaseURL(this) + "users");
    ...
    void removeNofiication(Context context, String notificationDate) {
        ...
        Firebase ref = new Firebase(DAL_Utilities.getDatabaseURL(this) + "users/" + preferences.getString
                ("logedIn", "") + "/Notifications/");
        ref.child(context.getString(org.tud.bp.fitup.R.string.stimmungsabgabe)).child(notificationDate).removeValue();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case org.tud.bp.fitup.R.id.icon_save:
                if (SaveData())
                    Toast.makeText(this, getString(org.tud.bp.fitup.R.string.Erfolgreich_gespeichert), Toast.LENGTH_SHORT).show();
                finish();
    ...
    private boolean SaveData() {
        ...
        if (INSERT) {
            ...
            ActivityMain.getMainUser(this).InsertStimmung(stimmungAbfrage, this);
            ActivityMain.getMainUser(this).InsertStimmungScore(stimmungAbfrageScore, this);
        } else {

            stimmungAbfrageScore.Date = stimmungAbfrage.Date;
            stimmungAbfrageScore.Time = stimmungAbfrage.Time;
            ActivityMain.getMainUser(this).UpdateStimmung(stimmungAbfrage, this);
            ActivityMain.getMainUser(this).UpdateStimmungScore(stimmungAbfrageScore, this);
    ...
    private void InitializeControlls() {
        ...
        lstTraurig = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvTraurig);
        lstTatkraeftig = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvTatkraeftig);
        lstZerstreut = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvZerstreut);
        lstWuetend = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvWuetend);
        lstAngespannt = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvAngespannt);
        lstMuede = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvMuede);
        lstSelbstsicher = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvSelbstsicher);
        lstMittelsam = (StimmungListview) findViewById(org.tud.bp.fitup.R.id.lvMitteilsam);

        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.angespannt));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.traurig));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.tatkraeftig));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.zerstreut));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.wuetend));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.muede));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.selbstsicher));
        ...
        adapter = new StimmungsViewAdapter(this);
        adapter.setStimmung(stimmungsAngabe, getString(org.tud.bp.fitup.R.string.mitteilsam));
    ...
    private void SetControlCaptions() {
        ((TextView) findViewById(org.tud.bp.fitup.R.id.txtMainQuestion)).setText(getString(org.tud.bp.fitup.R.string.bitte_geben_sie_moment_fuhlen));
        ((TextView) findViewById(org.tud.bp.fitup.R.id.txtAngespannt)).setText(getString(org.tud.bp.fitup.R.string.angespannt));
        ((TextView) findViewById(org.tud.bp.fitup.R.id.txtTraurig)).setText(getString(org.tud.bp.fitup.R.string.traurig));
    }
