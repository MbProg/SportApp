...
public class Activity_lst_stimmungsabfrage extends AppCompatActivity {
    ...
    private void deleteStimmungsabgabe(StimmungsAngabe stimmungsAngabe) {
        Firebase ref = new Firebase(DAL_Utilities.getDatabaseURL(this) + "users/" + ActivityMain.getMainUser
        ...
        try {
            ref = new Firebase(DAL_Utilities.getDatabaseURL(this) + "users/" + ActivityMain.getMainUser(this)
