...
public class ActivitySelectedExercises extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.tud.bp.fitup.R.layout.activity_selectedexercises);
        ...
        listView = (ListView) findViewById(org.tud.bp.fitup.R.id.listviewActivityOverview);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case org.tud.bp.fitup.R.id.delete_id: //remove item of the list
                exerciseList.remove(info.position);
                exerciseViewAdapter.notifyDataSetChanged();
                return true;
            case org.tud.bp.fitup.R.id.edit_id: //open a number picker to change the duration
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m != 0 || h != 0) {
                    ...
                    Toast.makeText(ActivitySelectedExercises.this, org.tud.bp.fitup.R.string.ungueltigeZeit, Toast.LENGTH_SHORT).show();
            }
        });
