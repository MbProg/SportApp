...
public class ActivityFragebogen extends AppCompatActivity {
    ...
    void getWochenanzahlFromDb() {
        try {
            Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(this) + "Administration/bsa/questionaryPeriodweeks");
    ...
    private boolean SaveData() {
        ...
        if (INSERT)
            ActivityMain.getMainUser(this).InsertFragebogen(fragebogen, this    );
        else
            ActivityMain.getMainUser(this).UpdateFragebogen(fragebogen, this    );
