...
public class FirebaseTest {
    ...
    public static void init() throws Exception{
        ...
        writeDAL_RegisteredUsers(instrumentationCtx);
        writeAlternatingGroupsUpdate(instrumentationCtx);
        writeFitnessFragebogen(instrumentationCtx);
        writeBSAFragebogen(instrumentationCtx);
        writeStimmung(instrumentationCtx);
     ...
     */
    private static void writeDAL_ThreadUsers(String username, String password, Context context) {
     ...
     * write data through DAL_RegisteredUsers
     */
    private static void writeDAL_RegisteredUsers(Context context) {
        DAL_RegisteredUsers.insertRegistration("TestRegistration", "testPassword", context);
        ...
        DAL_RegisteredUsers.insertMail("testMail@gmail.com", user, context);
    }

    /**
     * write data to change active group of the alternating group assignment
     */
    private static void writeAlternatingGroupsUpdate(final Context context) {

        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context) + "Administration/assignment/altern/altern1");
            ...
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    DAL_User.insertAlternGroupUpdate(currentActiveGroup.getKey(),
                            nextActiveGroup.getKey(), "altern1", context);
     ...
     */
    private static void writeFitnessFragebogen(Context context) {

        DAL_User.InsertFitnessFragebogen(User.Create("TestUserFelix"),testfitness1(), context);
        DAL_User.InsertFitnessFragebogen(User.Create("TestUserFelix"),testfitness2(), context);
        DAL_User.InsertFitnessFragebogen(User.Create("TestUserFelix"),testfitness3(), context);

        DAL_User.UpdateFitnessFragebogen(User.Create("TestUserFelix"),testfitness1(), context);
        DAL_User.UpdateFitnessFragebogen(User.Create("TestUserFelix"),testfitness2(), context);
        DAL_User.UpdateFitnessFragebogen(User.Create("TestUserFelix"),testfitness3(), context);
    ...
    private static void writeBSAFragebogen(Context context) {

        DAL_User.InsertFragebogen(User.Create("TestUserFelix"),testbsa1(), context);
        DAL_User.InsertFragebogen(User.Create("TestUserFelix"),testbsa2(), context);
        DAL_User.InsertFragebogen(User.Create("TestUserFelix"),testbsa3(), context);
        DAL_User.InsertFragebogen(User.Create("TestUserFelix"),testbsa3(),context);
    ...
    private static void writeStimmung(Context context) {

        DAL_User.InsertStimmung(User.Create("TestUserFelix"),teststimmung1(), context);
        DAL_User.InsertStimmungScore(User.Create("TestUserFelix"),teststimmungscore1() , context);
        DAL_User.InsertStimmung(User.Create("TestUserFelix"),teststimmung2(), context);
        DAL_User.InsertStimmung(User.Create("TestUserFelix"),teststimmung3(), context);
        DAL_User.InsertStimmung(User.Create("TestUserFelix"),teststimmung4(), context);
    ...
    @Test
    public void testReadRegistration(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users");
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    @Test
    public void testAlternatingGroupsUpdate(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context) + "Administration/assignment/altern/altern1/groups");
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    @Test
    public void testFitness1(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context) + "users/TestUserFelix/FitnessFragebogen/"+
                testfitness1().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    try {
                        Assert.assertEquals(testfitness1().Score_Ausdauer, dataSnapshot.getValue(FitnessFragebogen.class)
                                .Score_Ausdauer);
    ...
    @Test
    public void testFitness2(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/"+ testfitness2().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                // define behavior once data had been captured
    ...
    @Test
    public void testFitness3(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/"+
                testfitness3().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    @Test
    public void testBSA1(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/BSAFragebogen/"+
                testbsa1().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    // assert equality of captured data
                    try {
                        Assert.assertEquals(testbsa1().Berufstaetig, dataSnapshot.getValue(Fragebogen.class).Berufstaetig);
    ...
    @Test
    public void testBSA2(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/BSAFragebogen/"+
                testbsa2().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    @Test
    public void testBSA3(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/BSAFragebogen/"+
                testbsa3().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    @Test
    public void testBSA4(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/BSAFragebogen/"+
                testbsa4().Date);
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    @Test
    public void testStimmung1(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/" +
    ...
    @Test
    public void testStimmung2(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/" +
    ...
    @Test
    public void testStimmung3(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/" +
    ...
    @Test
    public void testStimmung4(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/FitnessFragebogen/" +
    ...
    @Test
    public void testStimmungScore1(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/StimmungsabfrageScore/" +
        ...
        try {
            root.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    // assert equality of captured data
                    try {
                        Assert.assertEquals(teststimmungscore1().AngespanntScore, dataSnapshot.getValue(StimmungAbfrageScore
    ...
    @Test
    public void testStimmungScore2(Context context) {
        Firebase root = new Firebase(DAL_Utilities.getDatabaseURL(context)+ "users/TestUserFelix/StimmungsabfrageScore/" +
